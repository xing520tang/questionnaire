...
function actionFormatter(value, row, index) {
    var result = "";
    result += "<a href='javascript:;' class='btn btn-xs green' onclick=\"InfoViewById('" + row.id + "')\" title='查看'><span class='glyphicon glyphicon-search'></span>查看</a>";
    result += "<a href='/views/paper_do.html?" + row.id + "'class='btn btn-xs blue'  title='编辑'><span class='glyphicon glyphicon-pencil'></span>作答</a>";
