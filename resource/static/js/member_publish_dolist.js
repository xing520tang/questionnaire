...
$(function () {
 ...
 paperId = window.location.search.split("?")[1];

var $table = $('#table').bootstrapTable({
    url: '/paper/user/publishDolist/' + paperId,
    method: 'GET',                      //请求方式（*）
...
function actionFormatter(value, row, index) {
    var result = "";
    result += "<a href='/views/paper_watch.html?" + paperId + "&" + row.id + "' class='btn btn-xs green'  title='查看回答'><span class='glyphicon glyphicon-search'></span>查看回答</a>";
